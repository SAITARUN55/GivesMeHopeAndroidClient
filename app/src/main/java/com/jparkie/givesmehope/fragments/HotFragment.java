...
public class HotFragment extends Fragment {
    ...
    private Observable<Anthology> mHotObservable;

    private HotAnthologyAdapter mHotAdapter;
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mHotAdapter = new HotAnthologyAdapter();
        mListView.setAdapter(mHotAdapter);

        // If mHotObservable persisted a configuration change, send a cached emission of the observable back to the list view.
        ...
        if (mHotObservable != null) {
            mHotSubscription = mHotObservable.subscribe(mHotAdapter);
        }
        ...
        if (savedInstanceState != null) {
            if (savedInstanceState.containsKey(Anthology.PARCELABLE_KEY)) {
                ...
                mHotAdapter.setAnthology(oldAnthology);
                // Update the list view to display the old data.
        ...
        mHotAdapter.actionPullNextAnthology();
    }
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        outState.putParcelable(Anthology.PARCELABLE_KEY, mHotAdapter.getAnthology());
    }
    ...
    private class HotAnthologyAdapter extends BaseAdapter implements Observer<Anthology> {
        private Anthology mAnthology;

        private boolean mIsLoading;

        public HotAnthologyAdapter() {
            this(GivesMeHopeInitializer.initializeHotAnthology());
        }

        public HotAnthologyAdapter(Anthology anthology) {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            if (currentView == null) {
                ...
                currentView = layoutInflater.inflate(R.layout.list_view_item_image, null);

                currentViewHolder = new ViewHolder();

                currentViewHolder.mImageView = (ImageView)currentView.findViewById(R.id.imageImageView);
                currentViewHolder.mFooterTextView = (TextView)currentView.findViewById(R.id.imageFooterTextView);
                currentViewHolder.mShareImageView = (ImageView)currentView.findViewById(R.id.imageShareImageView);
            ...
            Picasso.with(getActivity())
                    ...
                    .into(currentViewHolder.mImageView);
        ...
        public void actionPullNextAnthology() {
            ...
            mHotObservable = mGivesMeHopeService
